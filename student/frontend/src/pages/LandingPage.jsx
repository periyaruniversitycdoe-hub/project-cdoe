...
export default function LandingPage() {
  ...
  const handlePortalNavigation = (portal) => {
    ...
    if (portal.login_route.startsWith('http://') || portal.login_route.startsWith('https://')) {
    ...
    <div className="landing-dashboard" style={{
      ...
      <main className="container py-5 px-4" style={{ flex: '1 0 auto', maxWidth: '1200px', margin: '0 auto', position: 'relative', zIndex: 1 }}>
        <div className="text-center mb-5">
          <h2 className="fw-extrabold text-white mb-2" style={{ fontSize: '32px', letterSpacing: '-0.5px', textShadow: '0px 2px 4px rgba(0,0,0,0.3)', fontWeight: '800' }}>
            Ph.D. ERP Systems Portal
          </h2>
            ...
            {[1, 2, 3].map(i => (
              <div key={i} className="col-12 col-md-6 col-lg-4">
                <div className="card border-0 shadow-sm rounded-4 overflow-hidden" style={{ minHeight: '400px', backgroundColor: '#ffffff' }}>
                  <div className="placeholder-glow" style={{ height: '180px', backgroundColor: '#e9ecef' }} />
                  <div className="card-body p-4 d-flex flex-column gap-3">
                    <div className="placeholder-glow" style={{ width: '40px', height: '40px', borderRadius: '50%', backgroundColor: '#e9ecef' }} />
                    <div className="placeholder-glow" style={{ width: '60%', height: '24px', backgroundColor: '#e9ecef' }} />
                    <div className="placeholder-glow" style={{ width: '100%', height: '60px', backgroundColor: '#e9ecef' }} />
                    <div className="placeholder-glow mt-auto" style={{ width: '100%', height: '42px', borderRadius: '8px', backgroundColor: '#e9ecef' }} />
                  </div>
                </div>
              </div>
            ))}
                ...
                >
                  ...
                  <div className="card-body p-4 d-flex flex-column text-start" style={{ flex: '1 1 auto' }}>
                    ...
                    <button 
                      ...
                      className="btn w-100 py-2.5 mt-auto d-flex align-items-center justify-content-center gap-2 fw-semibold text-white transition-all rounded-3"
                      style={{
      ...
      <footer className="py-4 mt-auto border-top text-center" style={{
        ...
        <div className="container">
          ...
          <div className="text-white opacity-50 mt-1 small">Centralized Ph.D. Admission ERP Engine | Developed for Premium Academic Management</div>
        </div>
      </footer>
    </div>
  );
