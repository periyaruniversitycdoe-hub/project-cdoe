...
const HallTicket = () => {
    ...
    useEffect(() => {
        ...
        axios.get((import.meta.env.VITE_STUDENT_API_URL || 'http://localhost:5000') + '/api/settings', { signal })
            .then(res => setSettings(res.data.success ? res.data.data : res.data))
            .catch(() => {});

        axios.get((import.meta.env.VITE_STUDENT_API_URL || 'http://localhost:5000') + '/api/student/hall-ticket', {
            ...
            .catch(err => {
                ...
                setError('No hall ticket has been issued yet or you are not authorized.');
                setLoading(false);
            });

        return () => ac.abort();
    // navigate and token are stable/Zustand refs - empty dep fires once on mount.
    // eslint-disable-next-line react-hooks/exhaustive-deps
    }, []);

    if (loading) return <div className="p-5 text-center">Loading your Hall Ticket...</div>;
        ...
        <div className="bg-light min-vh-100 pb-5">
            ...
            <div className="container py-4 no-print">
                <div className="d-flex align-items-center justify-content-between mb-4">
                    <button className="btn btn-outline-secondary d-flex align-items-center gap-2 rounded-pill px-4" onClick={() => navigate('/dashboard')}>
                        <ArrowLeft size={16} /> Back to Dashboard
                    </button>
                    <button className="btn btn-primary fw-bold d-flex align-items-center gap-2 rounded-pill px-4" onClick={() => window.print()}>
            ...
            <div className="hall-ticket-container">
                <div className="hall-ticket-page bg-white shadow">
                    {/* Header Section */}
                    <div className="ht-header" style={{ display: 'flex', alignItems: 'center', gap: '20px' }}>
                        ...
                        <div className="ht-header-text" style={{ flex: 1, textAlign: 'left', padding: '0 10px' }}>
                            ...
                            <h3 className="section-title" style={{ fontSize: '13px', margin: '6px 0 0 0', fontWeight: 'bold', textDecoration: 'underline', textTransform: 'uppercase' }}>
                    ...
                    <div className="details-section">
                        <table className="details-table">
                            ...
                            <tr>
                                ...
                                <td className="value">{data.exam_venue}</td>
                            </tr>
                            </tbody>
                        </table>
                    </div>
