    ...
    <div style={{ minHeight: '100vh', background: 'linear-gradient(135deg, #1e1b4b 0%, #312e81 50%, #4338ca 100%)', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 20 }}>
      <div style={{ width: '100%', maxWidth: 440 }}>
        ...
        <div style={{ background: '#fff', borderRadius: 20, padding: '36px 32px', boxShadow: '0 24px 64px rgba(0,0,0,0.25)' }}>
          <h2 style={{ fontSize: 20, fontWeight: 700, color: '#1e293b', marginBottom: 6 }}>Reset Password</h2>
          <p style={{ fontSize: 13, color: '#64748b', marginBottom: 28 }}>Choose a highly secure, strong password for your supervisor account.</p>
          ...
          <form onSubmit={handleSubmit}>
            ...
            {/* Security checklist */}
            <div style={{ marginBottom: 20, background: '#f8fafc', padding: 14, border: '1px solid #e2e8f0', borderRadius: 10, fontSize: 11, color: '#475569' }}>
            ...
            <button
              ...
              style={{ 
                width: '100%', 
                padding: 14, 
                background: (loading || strength.score < 5 || password !== confirmPassword) ? '#a5b4fc' : 'linear-gradient(135deg, #4338ca, #312e81)', 
                color: '#fff', 
                border: 'none', 
                borderRadius: 12, 
                fontSize: 15, 
