    ...
    <div style={{ minHeight: '100vh', background: 'linear-gradient(135deg, #1e1b4b 0%, #312e81 50%, #4338ca 100%)', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 20 }}>
      <div style={{ width: '100%', maxWidth: 420 }}>
        ...
        <div style={{ background: '#fff', borderRadius: 20, padding: '36px 32px', boxShadow: '0 24px 64px rgba(0,0,0,0.25)' }}>
          <h2 style={{ fontSize: 20, fontWeight: 700, color: '#1e293b', marginBottom: 6 }}>Forgot Password</h2>
          <p style={{ fontSize: 13, color: '#64748b', marginBottom: 28 }}>Enter your registered supervisor email address to receive a verification OTP.</p>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <button type="submit" disabled={loading}
              style={{ width: '100%', padding: 14, background: loading ? '#a5b4fc' : 'linear-gradient(135deg, #4338ca, #312e81)', color: '#fff', border: 'none', borderRadius: 12, fontSize: 15, fontWeight: 700, cursor: loading ? 'not-allowed' : 'pointer', transition: 'all 0.2s', boxShadow: '0 4px 14px rgba(67,56,202,0.3)', marginBottom: 20 }}>
